...
function displayExperienceMatch(results) {
    const experienceScore = results.experience_score || results.experience?.score || 70;
    ...
    if (detailsElement) {
        let details = results.experience_details || results.experience?.details || 
...
function displayEducationMatch(results) {
    const educationScore = results.education_score || results.education?.score || 80;
    ...
    if (detailsElement) {
        let details = results.education_details || results.education?.details || 
